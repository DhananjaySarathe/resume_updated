...
export const disciplines = [
  {
    ...
    body: 'I built the Quickads frontend architecture in Next.js. It cut page load times by 30%, and every new screen uses the design system I set up.',
    chips: ['Next.js', 'React', 'Tailwind CSS', 'Design systems'],
  },
  {
    icon: 'brain',
    accent: 'secondary',
    ...
    chips: ['OpenAI API', 'Vision APIs', 'Prompt-to-ad', 'Ad analysis'],
  },
  {
    icon: 'server',
    accent: 'tertiary',
    ...
    chips: ['TypeScript', 'Node.js', 'APIs', 'State management'],
  },
  {
    icon: 'radar',
    accent: 'primary',
    ...
    body: 'ADAM is our set of SPY agents. They scrape competitor brands and keywords every day and report how those ads perform. Live Search scrapes Meta ads in real time.',
    chips: ['Scraping', 'Scheduled jobs', 'Meta Ad Library', 'Automation'],
  },
];
    ...
    highlights: [
      {
        ...
        body: 'Rebuilt the frontend architecture. Pages load 30% faster, and it now supports multiple domains.',
      },
      {
        icon: 'library',
        title: 'Ad Inspiration Library',
        body: 'More than a million indexed ads that marketers browse to research what is working.',
      },
      {
        icon: 'search',
...
export const principles = [
  { n: '01', text: 'Ship the first version, then make it hold up.' },
  { n: '02', text: 'Page speed is part of the feature.' },
  { n: '03', text: 'Build the UI kit before the hundredth screen.' },
  { n: '04', text: 'If I can explain it, I understand it.' },
];
...
export const stack = [
  { title: 'Languages', icon: 'code', accent: 'primary', items: ['TypeScript', 'JavaScript', 'C / C++', 'Python'] },
  {
    ...
    icon: 'layout',
    accent: 'secondary',
    items: ['Next.js', 'React', 'Tailwind CSS', 'HTML / CSS', 'Zustand'],
  },
  {
  ...
  },
  {
    ...
    icon: 'wrench',
    accent: 'primary',
    items: ['Git and GitHub', 'AST analysis', 'SheetJS', 'System design'],
  },
];
